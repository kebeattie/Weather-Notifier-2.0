...
response_API = requests.get("http://datapoint.metoffice.gov.uk/public/data/val/wxfcs/all/json/" + locationID + "?res=3hourly&key=60071ca7-b9e5-4686-92bc-4d405064b6ca") # Requests weather data for user specified location
